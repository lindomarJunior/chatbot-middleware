...
function create(sessionOrOption, catchQR, statusFind, options, browserSessionToken, browserInstance) {
    return __awaiter(this, void 0, void 0, function () {
        var session, browserToken, mergedOptions, logger, browser, page_1, client_1, isLogged, waitLoginPromise_1, debugURL;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, browser_1.initBrowser)(session, mergedOptions, logger)];
                case 1:
                    browser = _a.sent();
                    // Erro of connect wss
                    if (typeof browser === 'string' && browser === 'connect') {
                        ...
                        throw "Error when try to connect ".concat(mergedOptions.browserWS);
                    }
                    // Erro open browser
                ...
                case 2:
                    ...
                    logger.info("".concat(chalk.green('Page successfully accessed')), {
                        session: session
                    });
                ...
                case 4:
                    if (mergedOptions.debug) {
                        debugURL = "http://localhost:".concat((0, fs_1.readFileSync)("./".concat(session, "/DevToolsActivePort")).slice(0, -54));
                        console.log("\nDebug: \u001B[34m".concat(debugURL, "\u001B[0m"));
                    }
