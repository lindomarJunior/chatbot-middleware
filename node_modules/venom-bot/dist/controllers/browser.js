    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    waPage = _b.sent();
                    if (!(waPage != null)) return [3 /*break*/, 12];
                    _b.label = 2;
                case 2:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(options.useChrome && options.useChrome)) return [3 /*break*/, 1];
                    extras = __assign(__assign({}, extras), { executablePath: chromePath });
                    return [3 /*break*/, 4];
                case 1:
                    if (!options.BrowserFetcher) return [3 /*break*/, 3];
                    browserFetcher = puppeteer_extra_1.default.createBrowserFetcher(null);
