    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!token) {
                        pathToken = path.join(path.resolve(process.cwd() + options.mkdirFolderToken, options.folderNameToken), "".concat(session, ".data.json"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    try {
                        fs.writeFileSync(path.join(folder, "".concat(session, ".data.json")), JSON.stringify(token));
